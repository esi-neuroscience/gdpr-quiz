...
In order to process personal information, we typically need consent. 
...
Participants have the right to retract their consent and request the deletion of their data at any time. 
...
Personal data must be deleted when storing it is no longer necessary.
